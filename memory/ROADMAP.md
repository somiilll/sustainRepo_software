...
- Add a Super Admin editor for Scope 3 activity formula groups and their group-owned mappings. It must show every category/tree branch affected before publishing, preserve technical variables, prohibit cross-group assignment, and require an explicit clone before a group-owned formula or mapping is reused elsewhere.
