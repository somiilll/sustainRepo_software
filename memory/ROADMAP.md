...
## Completed Recently
- C5 Add/Edit disposal filtering is now backed by a canonical factor taxonomy: all 184 C5 factors retain their original IDs/activity strings and add base Activity + normalized disposal type fields. C5 presents base Activity before Activity Type; Composted and Other preserve full catalog coverage. **MIGRATION PREFLIGHT AND STRUCTURAL VALIDATION ONLY; NO FUNCTIONAL TESTING** per the user’s instruction.
