...
- Scope 3 Category 5 uses a durable disposal taxonomy: users select an Activity Type (Landfilled, Recycled, Combusted, anaerobic digestion variants, Composted, or Other) and then a base Activity. Factor IDs and original combined activity strings remain immutable for calculation and audit continuity.
