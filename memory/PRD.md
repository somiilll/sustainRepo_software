...
- Scope 3 Category 5 uses a durable disposal taxonomy: users select a base Activity first, then its disposal Activity Type (Landfilled, Recycled, Combusted, anaerobic digestion variants, Composted, or Other). Factor IDs and original combined activity strings remain immutable for calculation and audit continuity.
