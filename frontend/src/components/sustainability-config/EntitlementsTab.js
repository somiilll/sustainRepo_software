...
export function EntitlementsTab({ orgConfig, onSave, saving }) {
  ...
  useEffect(() => setEntitlements(mergeConfig(orgConfig?.entitlements)), [orgConfig]);
  ...
  const save = () => onSave({ entitlements: { ...entitlements, reports: { ...entitlements.reports, scope_1_2: scope12Available && entitlements.reports.scope_1_2, scope_1_2_3: scope3Available && entitlements.reports.scope_1_2_3 } } });
