...
const sidebarConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: 'supplier_assessment.documents', label: 'Documents', icon: 'FileSignature', path: '/supplier-assessment/documents', adminOnly: true },
      { key: 'supplier_assessment.trainings', label: 'Trainings', icon: 'GraduationCap', path: '/supplier-assessment/trainings', adminOnly: true },
      ...
      { key: 'supplier_assessment.my_esg', label: 'ESG', icon: 'ClipboardList', path: '/supplier-assessment/supplier/esg', supplierOnly: true },
      { key: 'supplier_assessment.my_ghg', label: 'GHG', icon: 'Cloud', path: '/supplier-assessment/emissions', supplierOnly: true },
      { key: 'supplier_assessment.my_documents', label: 'Documents', icon: 'FileSignature', path: '/supplier-assessment/documents/review', supplierOnly: true },
      { key: 'supplier_assessment.my_training', label: 'Trainings', icon: 'GraduationCap', path: '/supplier-assessment/training', supplierOnly: true },
    ],
  },
  {
    key: 'users',
