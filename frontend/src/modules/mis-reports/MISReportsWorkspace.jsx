...
export default function MISReportsWorkspace() {
  ...
  const generateSummary = async () => {
    ...
    setGenerating(true);
    try {
      const response = await axios.post(`${API}/mis-reports/emissions-summary`, payload(), requestConfig);
      setSummary(response.data); await refreshActivity(); toast.success('Emissions Summary generated.');
