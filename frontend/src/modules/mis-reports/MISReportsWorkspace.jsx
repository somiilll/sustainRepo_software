...
function ExecutiveReportSections({ report }) {
  ...
  const operationalKpis = report.operational_kpis || {};
  const supplierAssessment = report.supplier_assessment || {};
