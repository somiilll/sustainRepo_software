...
export default function GaugeCard({
  ...
  if (!targets.length) {
    return (
      <div className="relative flex flex-col overflow-hidden rounded-lg border border-stone-200 bg-white p-4 shadow-sm sm:p-5" data-testid="kpi-card-reduction-target-achieved">
  ...
  return (
    <div className="relative flex flex-col overflow-hidden rounded-lg border border-stone-200 bg-white p-4 shadow-sm transition-[box-shadow,border-color] duration-200 hover:border-stone-300 hover:shadow-md sm:p-5" data-testid="kpi-card-reduction-target-achieved">
