...
export const ReadOnlyTrainingViewer = ({ viewer }) => {
  ...
  if (viewer.viewer_type === 'video') return <video src={viewer.asset_url} controls controlsList="nodownload noremoteplayback" disablePictureInPicture className="aspect-video w-full bg-black" data-testid="admin-training-video-viewer" />;
