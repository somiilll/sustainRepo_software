...
export const SupplierOnboarding = ({ onboarding }) => {
  ...
  return <main className="mx-auto max-w-3xl space-y-8 py-6" data-testid="supplier-onboarding">
    <div><SupplierPageHeader title={`Welcome to Supplier Assessment of ${onboarding.parent_name}`} description="Let’s get your supplier account set up. Complete your facility information first, then review the tasks assigned to you." icon={Building2} iconClassName="border-emerald-200 bg-emerald-50 text-emerald-800" testId="supplier-onboarding" /><div className="mt-5"><div className="mb-2 flex justify-between text-sm"><span className="font-medium text-stone-700">Getting started</span><span className="text-stone-500">{completed} of 3 complete</span></div><Progress value={(completed / 3) * 100} className="h-2" data-testid="supplier-onboarding-progress" /></div></div>
