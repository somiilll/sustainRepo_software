...
export default function SupplierDocuments() {
  ...
  return <div className="space-y-8" data-testid="supplier-documents-page">
    <SupplierPageHeader title="Documents" description="Review the current documents from your customer and provide the requested response." testId="supplier-documents" />
    ...
    <AlertDialog open={Boolean(pendingSubmission)} onOpenChange={(open) => { if (!open) setPendingSubmission(null); }}>
      <AlertDialogContent data-testid="supplier-document-submit-confirmation-dialog">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription data-testid="supplier-document-submit-confirmation-description">Once submitted, your response for {pendingSubmission?.document.title || 'this document'} will be locked and cannot be edited unless your customer reopens it.</AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
