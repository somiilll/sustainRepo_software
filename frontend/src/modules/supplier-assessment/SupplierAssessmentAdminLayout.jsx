...
export default function SupplierAssessmentAdminLayout() {
  ...
  return <div className="space-y-6" data-testid="supplier-assessment-admin-layout">
    {!rankingOwnsPeriodControl && !supplierListOwnsPeriodControl && <div className="flex flex-wrap items-center justify-between gap-4 border-b border-stone-200 pb-4" data-testid="supplier-assessment-period-bar">
