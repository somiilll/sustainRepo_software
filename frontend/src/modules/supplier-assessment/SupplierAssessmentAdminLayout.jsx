...
export default function SupplierAssessmentAdminLayout() {
  ...
  return <div className="relative space-y-6" data-testid="supplier-assessment-admin-layout">
    {!rankingOwnsPeriodControl && !supplierListOwnsPeriodControl && !supplierGhgOwnsPeriodControl && !questionnaireOwnsPeriodControl && !documentsOwnPeriodControl && <div className="static flex justify-end sm:absolute sm:right-0 sm:top-0" data-testid="supplier-assessment-period-bar">
