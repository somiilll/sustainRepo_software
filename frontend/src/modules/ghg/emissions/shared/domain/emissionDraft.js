...
/** Reset only local, selection-dependent edit values when scope/category changes. */
export const resetEmissionDraftForSelectionChange = (draft, {
...
export const resetEmissionDraftForScope3MethodChange = (draft, scope3Method) => ({
  ...draft,
  scope3Method,
  spendCurrencyConversionMethod: 'standard',
  allocationMethod: '',
