...
SYSTEM_VARIABLES: List[dict] = [
    ...
    {"key": "ef_q_ch4", "label": "CH₄ Emission Factor per Quantity", "type": "property",
     "dimension": "emission_per_activity", "default_unit": "kgCH4/kg"},
    {"key": "ef_q_n2o", "label": "N₂O Emission Factor per Quantity", "type": "property",
     "dimension": "emission_per_activity", "default_unit": "kgN2O/kg"},
