...
_SOURCES = {
    ...
    QueryType.BRSR_LOOKUP: ["organization_esg_responses", "esg_response_submissions", "esg_question_configs"],
    QueryType.GRI_LOOKUP: ["organization_esg_responses", "esg_response_submissions", "esg_question_configs"],
    QueryType.BRSR_VERSION_HISTORY: ["organization_esg_responses", "esg_responses_versions"],
    QueryType.GRI_VERSION_HISTORY: ["organization_esg_responses", "esg_responses_versions"],
