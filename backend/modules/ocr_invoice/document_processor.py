...
HEADER_ALIASES = {
    ...
    "quantity": ["quantity", "qty", "billed_qty", "volume", "net_weight", "quantity_used"],
    "unit": ["unit", "units", "uom", "unit_of_measure", "unit_of_quantity", "unit_of_quantity_used", "measure"],
    "quantity_goods": ["quantity_goods", "quantity_of_goods", "quantity_of_goods_travelled", "goods_quantity", "weight", "weight_kg", "cargo_weight"],
    ...
    "distance_km": ["distance_km", "distance", "distance_travelled", "dist_km", "dist", "travel_distance", "km", "kms", "route_distance"],
    "origin": ["origin", "from", "from_location", "source", "departure", "pickup"],
    "destination": ["destination", "to", "to_location", "arrival", "drop", "dest"],
    ...
    "passenger_count": ["passenger_count", "passengers", "pax", "no_of_passengers_travelled", "number_of_passengers_travelled"],
    ...
    for raw in rows[header_index + 1:]:
        ...
        extracted.append({
            ...
            "line_items": [{
                ...
                "unit": value("unit"),
                "quantity_goods": value("quantity_goods") or value("quantity"),
                "unit_goods": value("unit_goods") or value("unit"),
                ...
                "freight_details": {
                    ...
                    "quantity_goods": value("quantity_goods") or value("quantity"), "weight_unit": value("unit_goods") or value("unit"),
