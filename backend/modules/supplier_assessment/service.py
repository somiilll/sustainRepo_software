...
class SupplierAssessmentService:
    ...
    assign_questionnaire_to_supplier = _delegate_to(questionnaire_operations, questionnaire_operations.assign_questionnaire_to_supplier)
    unassign_questionnaire_from_supplier = _delegate_to(questionnaire_operations, questionnaire_operations.unassign_questionnaire_from_supplier)
